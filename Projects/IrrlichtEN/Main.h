...
#pragma message ("*************************************************************")
#include "Include/EnginePublic.h"

typedef engineEData EDITDATA;
typedef engineRData RUNDATA;
typedef engineEData* LPEDATA;
typedef engineRData* LPRDATA;
/*#define EDITDATA engineEData
#define RUNDATA engineRData
#define LPEDATA engineEData*
#define LPRDATA engineRData**/
#define IDENTIFIER	MAKEID(I,R,E,N)		// REQUIRED: you MUST replace the letters in the MAKEID macro by others
